...
namespace Lavie.Modules.Project.Repositories
{
    ...
    public interface ILavieDbContext : System.IDisposable
    {
        ...
        int sp_updatestaffworks(int? year, int? month, string v);
        // sp_updatestaffworksAsync cannot be created due to having out parameters, or is relying on the procedure result (int)
    ...
    public class LavieDbContext : System.Data.Entity.DbContext, ILavieDbContext
    {
        ...
        public int sp_updatestaffworks(int? year, int? month, string v)
        {
            var yearParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@year", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Input, Value = year.GetValueOrDefault(), Precision = 10, Scale = 0 };
            if (!year.HasValue)
                yearParam.Value = System.DBNull.Value;
            ...
            var vParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@v", SqlDbType = System.Data.SqlDbType.NVarChar, Direction = System.Data.ParameterDirection.Input, Value = v, Size = 2000 };
            if (vParam.Value == null)
                vParam.Value = System.DBNull.Value;

            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };

            Database.ExecuteSqlCommand(System.Data.Entity.TransactionalBehavior.DoNotEnsureTransaction, "EXEC @procResult = [dbo].[sp_updatestaffworks] @year, @month, @v", yearParam, monthParam, vParam, procResultParam);
    ...
    public class Staff
    {
        ...
        /// <summary>
        /// Parent (One-to-One) Staff pointed by [StaffWork].[StaffID] (FK_StaffWork_Staff)
        /// </summary>
        public virtual StaffWork StaffWork { get; set; } // StaffWork.FK_StaffWork_Staff
        /// <summary>
    ...
    public class User
    {
        ...
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Notification> FromUser { get; set; } // Notification.FK_Notification_User_FromUserID
        /// <summary>
        /// Child Notifications where [Notification].[ToUserID] point to this entity (FK_Notification_User_ToUserID)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Notification> ToUser { get; set; } // Notification.FK_Notification_User_ToUserID
        /// <summary>
        ...
        public User()
        {
            FromUser = new System.Collections.Generic.List<Notification>();
            ToUser = new System.Collections.Generic.List<Notification>();
            NotificationUsers = new System.Collections.Generic.List<NotificationUser>();
            Permissions = new System.Collections.Generic.List<Permission>();
            Roles = new System.Collections.Generic.List<Role>();
        }
    ...
    public class NotificationConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Notification>
    {
        ...
        public NotificationConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.FromUser).WithMany(b => b.FromUser).HasForeignKey(c => c.FromUserID).WillCascadeOnDelete(false); // FK_Notification_User_FromUserID
            HasOptional(a => a.ToUser).WithMany(b => b.ToUser).HasForeignKey(c => c.ToUserID).WillCascadeOnDelete(false); // FK_Notification_User_ToUserID
        }
    }
    ...
    public class StaffTurnoverFlowConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<StaffTurnoverFlow>
    {
        ...
        public StaffTurnoverFlowConfiguration(string schema)
        {
            ...
            HasRequired(a => a.StaffTurnoverAuditFlow).WithOptional(b => b.StaffTurnoverFlow).WillCascadeOnDelete(false); // FK_StaffTurnoverFlow_Group
        }
    }
    ...
    public class StaffWorkConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<StaffWork>
    {
        ...
        public StaffWorkConfiguration(string schema)
        {
            ...
            Property(x => x.Month).HasColumnName(@"Month").HasColumnType("int").IsRequired();
            ...
            // Foreign keys
            HasRequired(a => a.Staff).WithOptional(b => b.StaffWork).WillCascadeOnDelete(false); // FK_StaffWork_Staff
        }
    }
