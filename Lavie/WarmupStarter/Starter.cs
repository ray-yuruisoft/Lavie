...
namespace Lavie.WarmupStarter
{
    public class Starter<T> where T : class
    {
        ...
        private readonly Action<HttpApplication, T> _disponse;
        private readonly Action<HttpApplication, T> _beginRequest;
        private readonly Action<HttpApplication, T> _postMapRequestHandler;
        ...
        public Starter(Func<HttpApplication, T> initialization, Action<HttpApplication, T> disponse, Action<HttpApplication, T> beginRequest, Action<HttpApplication, T> postMapRequestHandler, Action<HttpApplication, T> endRequest)
        {
            _initialization = initialization;
            _disponse = disponse;
            _beginRequest = beginRequest;
            _postMapRequestHandler = postMapRequestHandler;
        ...
        public void OnApplicationEnd(HttpApplication application)
        {
            ...
            {
                _disponse(application, _initializationResult);
            }
        }
        ...
        public void OnPostMapRequestHandler(HttpApplication application)
        {
            if (_initializationResult != null)
            {
                _postMapRequestHandler(application, _initializationResult);
            }
        }
