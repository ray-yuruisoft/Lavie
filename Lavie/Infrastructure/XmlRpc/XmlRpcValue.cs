...
namespace Lavie.Infrastructure.XmlRpc
{
    internal class XmlRpcValue
    {
        ...
        {
            XElement typeElement = _valueElement.Element(typeElementName);
        ...
        {
            XElement typeElement = _valueElement.Elements().First();
        ...
        {
            XElement typeElement = _valueElement.Element("array");
        ...
        {
            XElement typeElement = _valueElement.Element("struct");
